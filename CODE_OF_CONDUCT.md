...
leaders responsible for enforcement at **conduct@tx402.io**.
...
> **This is not the channel for security vulnerabilities.** Those go through
> [GitHub Private Vulnerability Reporting](https://github.com/neogeeks/tx402/security/advisories/new)
> — see [SECURITY.md](SECURITY.md). A code-of-conduct inbox is not an authenticated disclosure
