...
tx402 budget          <url|host> --network <CAIP2> [--asset <ADDR>]
                                 [--max-per-hour <MONEY>] [--max-total <MONEY>]   (data)
...
{ "schemaVersion": 1, "ok": true, "exitCode": 0, "scope": "api.merchant.example",
  "network": "eip155:8453",
...
{ "schemaVersion": 1, "ok": true, "exitCode": 0, "scope": "api.merchant.example",
  "network": "eip155:8453",
  "recipients": ["0xabcdef0000000000000000000000000000000001",
