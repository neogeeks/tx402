  ...
  integrations: [
    starlight({
      ...
      sidebar: [
        ...
        // The hosted tools are a different property, so they cannot be autogenerated from
        // a directory here. Six pages link out to them from the point where the reader has
        // the question a tool answers, but those are asides in the middle of long pages —
        // discoverable while reading that page, invisible to someone scanning the sidebar
        // for what else exists. This is the standing entry.
        {
          label: "Hosted tools",
          items: [
            {
              label: "tools.tx402.io",
              link: "https://tools.tx402.io",
              attrs: { target: "_blank", rel: "noopener" },
              badge: { text: "free", variant: "note" },
            },
            {
              label: "Inspect an endpoint",
              link: "https://tools.tx402.io/inspect",
              attrs: { target: "_blank", rel: "noopener" },
            },
            {
              label: "Verify a challenge",
              link: "https://tools.tx402.io/verify",
              attrs: { target: "_blank", rel: "noopener" },
            },
            {
              label: "Policy playground",
              link: "https://tools.tx402.io/policy",
              attrs: { target: "_blank", rel: "noopener" },
            },
            {
              label: "Debug a failed payment",
              link: "https://tools.tx402.io/replay",
              attrs: { target: "_blank", rel: "noopener" },
            },
          ],
        },
