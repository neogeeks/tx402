  ...
  integrations: [
    starlight({
      ...
      sidebar: [
        ...
        // One entry, one page. The hosted tools are a different property and cannot be
        // autogenerated from a directory, and a five-link group here competed with the SDK
        // navigation rather than sitting alongside it.
        { label: "tools.tx402.io", link: "/tools/" },
      ],
